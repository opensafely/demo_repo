...
# save the plot
ggsave(here::here("output", "measures", "measures_by_conditions_yearly.png"),
...
##--- monthly measures - concatenated into years
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_conditions_yearly2.png"),
