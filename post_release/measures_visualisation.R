...
# save the plot
ggsave(here::here("output", "measures", "measures_by_age_groups_yearly.png"),
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_age_groups_yearly2.png"),
...
# import measure
df_year_ages <- bind_rows(
  read_csv(here::here("output", "measures", "measure_had_prescription_by_age_restricted_pop_yearly.csv")) %>% 
    mutate(measure = "Had Any Inhalers"),
  read_csv(here::here("output", "measures", "measure_had_multiple_inhalers_by_age_restricted_pop_yearly.csv")) %>% 
    mutate(measure = "Had Multiple Inhalers"),
  read_csv(here::here("output", "measures", "measure_has_asthma_copd_by_age_restricted_pop_yearly.csv")) %>% 
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_age_groups_restricted_pop_yearly.png"),
       plot_year_ages, height = 12, width = 14)
...
df_year_conditions <- bind_rows(
  read_csv(here::here("output", "measures", "measure_had_prescription_by_condition_restricted_pop_yearly.csv")) %>%
    mutate(measure = "Had Any Inhalers"),
  read_csv(here::here("output", "measures", "measure_had_multiple_inhalers_by_condition_restricted_pop_yearly.csv")) %>%
    mutate(measure = "Had Multiple Inhalers")
)
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_conditions_restricted_pop_yearly.png"),
...
# import measure
df_month_ages <- bind_rows(
  read_csv(here::here("output", "measures", "measure_had_prescription_by_age_restricted_pop_monthly.csv")) %>% 
    mutate(measure = "Had Any Inhalers"),
  read_csv(here::here("output", "measures", "measure_had_multiple_inhalers_by_age_restricted_pop_monthly.csv")) %>% 
    mutate(measure = "Had Multiple Inhalers"),
  read_csv(here::here("output", "measures", "measure_has_asthma_copd_by_age_restricted_pop_monthly.csv")) %>% 
    mutate(measure = "Diagnosis of Asthma or COPD")
) %>% 
  mutate(
    start = case_when(
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_age_groups_restricted_pop_monthly.png"),
       plot_month_ages, height = 12, width = 14)
...
df_month_conditions <- bind_rows(
  read_csv(here::here("output", "measures", "measure_had_prescription_by_condition_restricted_pop_monthly.csv")) %>%
    mutate(measure = "Had Any Inhalers"),
  read_csv(here::here("output", "measures", "measure_had_multiple_inhalers_by_condition_restricted_pop_monthly.csv")) %>%
    mutate(measure = "Had Multiple Inhalers")
) %>%
  mutate(
    start = case_when(
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_conditions_restricted_pop_monthly.png"),
...
# save the plot
ggsave(here::here("output", "measures", "measures_by_age_groups_restricted_pop_yearly2.png"),
       plot_year_ages2, height = 12, width = 14)
...
# save the plot
ggsave(here::here(
  "output", "measures", "measures_by_conditions_restricted_pop_yearly2.png"),
